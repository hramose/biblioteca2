...
@section('contentheader_description', trans('todo.ediperf2s2'))

@section('main-content')
{!! Form::model($perfiles_biblioteca, [
    'method' => 'PATCH',
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{!! trans('perfiles_biblioteca.heading_edit') !!}</div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            ...
                            &nbsp;
                            {!! Form::submit(trans('perfiles_biblioteca.button_edit'), ['class' => 'btn btn-primary']) !!}
                        </div>
                    </div>

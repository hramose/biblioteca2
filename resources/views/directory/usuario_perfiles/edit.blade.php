...
@section('contentheader_description', trans('todo.p2wsxe'))
@section('main-content')
{!! Form::model($usuario_perfile, [
    'method' => 'PATCH',
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{!! trans('usuario_perfiles.heading_edit') !!}</div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            ...
                            &nbsp;
                            {!! Form::submit(trans('usuario_perfiles.button_edit'), ['class' => 'btn btn-primary']) !!}
                        </div>
                    </div>

...
@section('contentheader_description', trans('todo.ediusuf2s2'))
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{!! trans('usuario.heading_edit') !!}</div>
            ...
            Auth::getUser()->tipo_usuario=="EDITOR")
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            ...
                            &nbsp;
                            {!! Form::submit(trans('usuario.button_edit'), ['class' => 'btn btn-primary']) !!}
                        </div>
                    </div>
